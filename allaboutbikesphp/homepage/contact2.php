    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navMenu">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="homepage.php#about">
              <i class="bi bi-info-circle-fill"></i> About
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo ($current === 'contact2.php') ? 'active' : ''; ?>" href="contact2.php">
      ...
      anchor.addEventListener('click', function(e) {
        if (this.hash) {
          ...
          if (target) {
            ...
            window.location.href = this.href; // fallback to navigate if element not on this page
          }
        }
      });
    });
